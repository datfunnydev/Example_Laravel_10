<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id=kt_aside>
    <div class="brand flex-column-auto" id=kt_brand>
        <a href="{{ url('/') }}" class=brand-logo>
            <img style=max-height:40px alt=Logo id="logo" src="{{ asset('images/logo/logo.png') }}" />
        </a>
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id=kt_aside_menu_wrapper>
        <div id=kt_aside_menu class="aside-menu my-4" data-menu-vertical=1 data-menu-scroll=1
            ...
            <ul class=menu-nav>
                <li id="roles" class="menu-item" aria-haspopup=true>
                    <a href="{{ url('/roles') }}" class=menu-link>
                        ...
                        <span class=menu-text>{{ __('Chức vụ') }}</span>
                    </a>
                </li>
                <li id="users" class="menu-item" aria-haspopup=true>
                    <a href="{{ url('/users') }}" class=menu-link>
                        ...
                        <span class=menu-text>{{ __('Nhân viên') }}</span>
                    </a>
                </li>
                <li id="log-activities" class="menu-item" aria-haspopup=true>
                    <a href="{{ url('/log-activities') }}" class=menu-link>
                        <span class="svg-icon menu-icon">
                            <svg width="24px" height="24px" viewBox="0 0 24 24">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                        ...
                        <span class=menu-text>{{ __('Lịch sử hoạt động') }}</span>
                    </a>
                </li>
            </ul>
        </div>
