...
class DeleteUserDataTable extends DataTable
{
    public function dataTable($query): EloquentDataTable
    {
        ...
        return $dataTable->addIndexColumn()
            ->addColumn('action', 'admin.user.table_delete_action')
            ->editColumn('deleted_at', function ($query) {
                return Carbon::parse($query->deleted_at)->toDateTimeString();
            });
    }

    public function query(): Builder
    {
        return (new UserRepository())->delete_user_datatable();
    }
    ...
    public function html(): YajraBuilder
    {
        return $this->builder()
            ...
            ->minifiedAjax('/users?type=deleted')
    ...
    protected function getColumns(): array
    {
        return [
            ...
            'deleted_at' => (new Column([
                'title' => __('Thời gian xoá'),
                'data' => 'deleted_at',
                'searchable' => true,
                'orderable' => false,
            ])),
